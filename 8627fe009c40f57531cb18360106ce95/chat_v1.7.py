...
def is_greeting(question):
    ...
    # Common greeting words / patterns
    greeting_words = {"hi", "hello", "hey", "good", "morning", "afternoon", "evening",
                      "how", "are", "you", "what's", "up", "sup", "yo"}
    # Simple heuristic: if "hi/hello/hey" appears alone, or "how" and "you" appear together
...
def model_guided_cache(question, temperature=0.2, probe_tokens=5):
    ...
    # Collect all words from the probe, but skip trivial one‑letter words (a, i) if there are longer words
