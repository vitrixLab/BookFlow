    ...
    <div className="sap-login-container">
      ...
      <style jsx>{`
        ...
        .social-btn {
          ...
          padding: 0.65rem 0.5rem; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.12);
          background: white; font-size: 0.85rem; font-weight: 600; cursor: pointer;
          transition: transform 0.16s var(--ease-out), box-shadow 0.16s ease, border-color 0.16s ease, color 0.16s ease;
          color: #4a6278;
        }
        ...
        .links-horizontal a { color: #4a6278; text-decoration: none; transition: color 0.16s ease; }
