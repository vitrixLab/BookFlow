...
export default function AdminAIAssistant({
  ...
  return (
    <>
      <Head>
        <title>{PAGE.title || 'AI Assistant'} | Admin</title>
      </Head>
      <DashboardLayout user={user}>
        <div className="ai-fullpage">
          <header className="ai-header">
            <h1 className="ai-title">{PAGE.title}</h1>
            <span className="ai-subtitle">{PAGE.subtitle}</span>
          </header>
          ...
          <div className="ai-chat-panel">
            ...
            <div className="ai-input-area">
              <input
                ...
                disabled={loading}
                className="ai-input"
                aria-label={PAGE.inputPlaceholder}
              />
              <button
                onClick={sendMessage}
                disabled={loading}
                className="ai-send-btn"
                aria-label={PAGE.sendAria}
              >
